...
export default function Student(){
    ...
    const dataadd=(e)=>{
        e.preventDefault()
        axios.post("http://127.0.0.1:8000/api/StudentRegisterAPIView",inputs).then((res)=>{
  ...
  return(
    ...
    <form className="registration-form">
        ...
        <select class="form-select" name="course" onChange={handleInputChange} required>
            <option value="Select a course" >Select a Course</option>
            <option value="course1">HTML</option>
            <option value="course2">Django</option>
            <option value="course3">Python</option>
        </select>
        <select class="form-select" name="department" onChange={handleInputChange} required>
        ...
        <input type="submit" className="form-button" onClick={dataadd} value="Register"></input>
    </form>
    </div>
